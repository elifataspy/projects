...
Original file is located at
    https://colab.research.google.com/drive/10NiFI65U7dlwLrAOuAioAPkW6uwLX1sF
"""
...
train = pd.read_csv("/content/drive/MyDrive/COLAB/HousePrice_Scoutium/data/house_price_train.csv")
test = pd.read_csv("/content/drive/MyDrive/COLAB/HousePrice_Scoutium/data/house_price_test.csv")
